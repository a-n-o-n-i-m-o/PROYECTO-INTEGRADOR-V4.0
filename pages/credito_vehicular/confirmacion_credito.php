...
<head>
    ...
    <div class='buttons'>
        <form id="formCredito">
            ...
            <input type="hidden" name="montoVehiculo" value="<?php echo $_SESSION['datos_credito']['montoVehiculo']; ?>">
            <input type="hidden" name="marca" value="<?php echo $_SESSION['datos_credito']['marcaVehiculo']; ?>">
            <input type="hidden" name="modelo" value="<?php echo $_SESSION['datos_credito']['modeloVehiculo']; ?>">
            <input type="hidden" name="porcentajeCuotaInicial" value="<?php echo $_SESSION['datos_credito']['cuotaInicial']; ?>">
            <input type="hidden" name="plazoMeses" value="<?php echo $_SESSION['datos_credito']['plazo']; ?>">
